...
export default function Login() {
    ...
    return (
        <div>
            ...
            <main className="bg-[url('@/assets/img/auth/login.jpg')] bg-cover bg-no-repeat">
                <div className="container mx-auto px-4 py-24 md:px-36">
                    <form className="p-6 md:p-10 my-5 ml-auto md:w-2/5 border border-1 rounded-md bg-white">
